          ...
          <Col>
            ...
            <div style={{margin:'2% 0'}}>
              ...
              <Row>
                ...
                <Col span={8} >
                <br/>
                  <div style={{color:'#FF1367',margin:'0 20%'}} onClick={this.showModal} >{this.state.closeIntro?
                  (<span><MyIcon type='icon-spread'/>展开全部</span>):(<span><MyIcon type='icon-shrink'/>收起</span>)}</div>
                </Col>
                <Col span={8} />
              </Row>
          </div></Col>
