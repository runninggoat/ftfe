    ...
    <Row>
      <Col  span={24}>
        ...
        <Row>
          ...
          <Col span={6}>
            <div style={{}}>
              <Tag style={{border:0,borderRadius:'10px',background:"linear-gradient(90deg,rgba(255,132,135,1) 0%,rgba(255,19,103,1) 100%)"}}>
                <span style={{color:'#FFFFFF'}}>视频</span> 
              </Tag>
              <Tag style={{border:0,borderRadius:'10px',background:"#EEEEEE"}}>
